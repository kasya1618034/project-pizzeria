/* global Handlebars, utils, dataSource */ // eslint-disable-line no-unused-vars
{
  ...
  class Product {
    ...
    renderInMenu() {
      ...
      /* create element using utils.creatElementFromHTML */
      ...
      for (let paramId in thisProduct.data.params) {
        ...
        for (let optionId in param.options) {
          ...
          if (optionSelected) {
            ...
            //if not selected --> check if it is not default option, if yes: decrease price according to component's value
  ...
  class Cart {
    ...
    update() {
      ...
      thisCart.products.forEach.call(thisCart.dom.totalPrice, function(bothTotal){
        bothTotal.innerHTML = thisCart.totalPrice;
      });  
    }

    remove(productRemoved) {
      const thisCart = this;

      productRemoved.dom.wrapper.remove();
      const indexOfProductRemoved = thisCart.products.indexOf(productRemoved);
      thisCart.products.splice(indexOfProductRemoved, 1);
      thisCart.update();
    }
